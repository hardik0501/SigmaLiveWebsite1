...
export function LocationEnquiryModal({
  location,
  isOpen = true,
  onClose,
}: LocationEnquiryModalProps) {
          ...
          {submitted ? (
            <div className="py-10 text-center space-y-4">
              ...
              <p className="text-sm text-sigma-stone-600 max-w-xs mx-auto">
                ...
                <span className="font-semibold text-sigma-blue-700">{location.name}</span> will share the property options with you shortly.
              </p>
            </div>
          ) : (
            <div>
              <span className="eyebrow text-sigma-blue-600">Location Concierge</span>
              <h2 className="text-2xl font-bold font-serif text-sigma-graphite-900 mt-1">
                Explore Options in {location.name}
              </h2>
              ...
              <div className="mt-4 p-3 bg-sigma-stone-100/80 border border-sigma-stone-200/80 rounded-2xl flex items-center gap-2 text-xs font-semibold text-sigma-graphite-900">
                ...
                <span>Target Locality: {location.name}, {location.city}</span>
              </div>
              ...
              <form onSubmit={handleSubmit} className="mt-5 space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    rows={3}
                    placeholder="e.g. Looking for ready-to-move 3 BHK near metro station with budget ₹50-70L."
