...
export function SiteVisitModal({ project, isOpen = true, onClose }: SiteVisitModalProps) {
          ...
          {submitted ? (
            <div className="py-10 text-center space-y-4">
              ...
              <p className="text-sm text-sigma-stone-600 max-w-xs mx-auto">
                ...
                <span className="font-semibold text-sigma-blue-700">{project.name}</span> will confirm your appointment for{' '}
                <span className="font-semibold">{formData.preferredDate}</span>.
              </p>
            </div>
          ) : (
            <div>
              <span className="eyebrow text-sigma-blue-600">VIP Private Tour</span>
